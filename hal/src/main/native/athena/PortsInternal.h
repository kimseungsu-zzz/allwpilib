...
// CAN power/pneumatics channel counts are shared with the VMX build and are
// defined once there; only the FPGA-derived counts live in this header.
#include "../shared/PortsInternal.h"
